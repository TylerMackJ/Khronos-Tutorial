    ...
    fragShaderModule( createShaderModule( HelloTriangleApplication::readFile( "shader.frag.spv" ) ) )
{
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = HelloTriangleApplication::getSwapChain().getSwapChainExtent().width;
    viewport.height = HelloTriangleApplication::getSwapChain().getSwapChainExtent().height;
